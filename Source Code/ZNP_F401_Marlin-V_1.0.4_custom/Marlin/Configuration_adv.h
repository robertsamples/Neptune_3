 ...
 */
#define HOST_ACTION_COMMANDS //MOD
#if ENABLED(HOST_ACTION_COMMANDS)
  #define HOST_PAUSE_M76 //MOD
  #define HOST_PROMPT_SUPPORT //MOD
  #define HOST_START_MENU_ITEM      // Add a menu item that tells the host to start //MOD
  #define HOST_SHUTDOWN_MENU_ITEM   // Add a menu item that tells the host to shut down //MOD
#endif
